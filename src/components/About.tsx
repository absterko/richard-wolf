      ...
      <Slide>
        <div className="about">
          <div className="about-text">
            ...
            <p>
              Around 2019, I started to fall in love with coding. As a person
              who loves technology, I started to educate myself through various
              courses until the moment when I got a job as a front-end developer
              at the international blockchain start-up project. My task was the
              ...
              language. After less than a year on the project, I joined a large
              software company as a software developer where I was part of many
              large and small e-commerce projects primarily technologically
